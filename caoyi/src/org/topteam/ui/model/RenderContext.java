...
public class RenderContext {
    ...
    private final Map<String, TagRender> tags = new TreeMap<String, TagRender>();
    ...
    public void write(JspWriter out, String var) throws IOException {
        ...
        ScriptWriter tagsRender = new ScriptWriter();
        tagsRender.ready();
        // loop all tags
        for (Iterator<String> iterator = tags.keySet().iterator(); iterator.hasNext(); ) {
            ...
            tagsRender.write(afterScript == null ? "" : afterScript);
            tagsRender.write("\n");
        }
        out.write(tagsRender.toString());
        if (tags != null) {
    ...
    private Map<String, String> buildEasyEventScript(List<EventListenerTag> listeners, List<EventTag> events) {
        ...
        for (EventListenerTag listener : listeners) {
            ...
            if (param == null) {
                sb.append(listener.getListener()).append(".apply(this,arguments);").append("\n");
            } else {
                sb.append(listener.getListener()).append(".apply(this,[").append(param).append("]);").append("\n");
            }
