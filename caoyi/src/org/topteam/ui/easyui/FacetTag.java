...
public class FacetTag extends TagRender {
    ...
    public void renderStart(JspWriter out) {
        ...
        } else if (getName().equals("toolbar")) {
            if (parent instanceof DialogTag) {
                DialogTag dialogTag = (DialogTag) parent;
                dialogTag.setToolbar("#" + getId());
            }
        } else if (getName().equals("buttons")) {
            if (parent instanceof DialogTag) {
                DialogTag dialogTag = (DialogTag) parent;
                dialogTag.setButtons("#" + getId());
            }
        }
    ...
    public void renderEnd(JspWriter out) throws JspException {
        try {
            Tag parent = getParent();
            if (getName().equals("tools") || getName().equals("menu") || getName().equals("toolbar") || getName().equals("buttons")) {
