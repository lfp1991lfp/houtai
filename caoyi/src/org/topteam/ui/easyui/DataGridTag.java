...
public class DataGridTag extends TagRender {
    ...
    public Map<String, Object> getOptions() {
        ...
        options.put("pagination", getPagination());   //分页工具栏
        options.put("rownumbers", getRownumbers());   //是否显示序号
        options.put("singleSelect", getSingleSelect());//单选
        ...
        options.put("pageSize", getPageSize());       //每页个数
        if(getPageList()!=null){
